...
class MeasureQuantityFormatTest {
  ...
  @Test
  void testFormatZero() {
    QuantityFormat format = new MeasureQuantityFormat(new DecimalFormat("0.#"), new MeasureUnitFormat());
  ...
  void testFormatShort4() {
    QuantityFormat format = new MeasureQuantityFormat(new RationalFormat(), new MeasureUnitFormat());
  ...
  @Test
  void testFormatList() {
    MeasureQuantityFormat format = new MeasureQuantityFormat(new MeasureUnitFormat());
